        ...
        Rectangle {
            ...
            ScrollView {
                ...
                ColumnLayout {
                    ...
                    Repeater {
                        model: Services.Volume.sources
   
                        delegate: Item {
                            id: delegate
   
                            required property var modelData
                            property bool isDefault: modelData === Services.Volume.defaultSource
                            property string sourceName: modelData?.name ?? ""
                            ...
                            Process {
                                id: pactlSetSource
                                command: ["pactl", "set-default-source", delegate.sourceName]
                            }
                                ...
                                TapHandler {
                                    onTapped: {
                                        if (!delegate.isDefault) {
                                            pactlSetSource.running = true
                                            Services.Volume.setDefaultSource(delegate.modelData)
                                        }
                                    }
                                }
                            }
