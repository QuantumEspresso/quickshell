    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                color: Services.Bluetooth.defaultAdapter?.enabled
                ...
                Rectangle {
                    ...
                    radius: 10
                    y: 3
                    x: Services.Bluetooth.defaultAdapter?.enabled ? parent.width - width - 3 : 3
                    color: ColorsModule.Colors.on_surface
        ...
        Rectangle {
            ...
            ListView {
                ...
                Text {
                    ...
                    text: Services.Bluetooth.defaultAdapter?.enabled
                        ? "No devices found"
                        : "Bluetooth disabled"
                    color: ColorsModule.Colors.on_surface_variant
                }
